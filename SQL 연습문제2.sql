...
insert into `bank_customer` values ('730423-1000003','선덕여왕',1,'010-1234-1003','서울시 마포구');
insert into `bank_customer` values ('730423-1000004','강감찬',1,'010-1234-1004','서울시 영등포구');
insert into `bank_customer` values ('730423-1000005','신사임당',1,'010-1234-1005','강원도 강릉시');
insert into `bank_customer` values ('730423-1000006','이순신',1,'010-1234-1006','부산시 영도구');
...
insert into `bank_account` values ('101-12-1002','S2','정기적립예금','830513-2000005','1200500','2009-05-13');
...
#실습 2-15
select sum(`t_amount`) as '입금 총액', avg(`t_amount`) as '입금 평균' from `bank_transaction` where `t_dist` =1;

#실습 2-16
select max(`t_amount`) as '최eo값', min(`t_amount`) as '최소값' from `bank_transaction` where `t_dist` = 2;
...
#실습 2-25
select * from `bank_account` as a join `bank_customer` as b
on a.a_c_no = b.c_no;
